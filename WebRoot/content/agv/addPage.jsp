...
<script type="text/javascript">
	$(function() {
		$("#submit").click(function(){
            ...
            $.post("<%=basePath%>agv/add",$("#addform").serialize(),function(data){
                data = $.parseJSON(data);
                if(data.success){
                    alertMsg("添加成功！");
                    setTimeout(function(){
                            ...
                            <table class="form_table pt15 pb15" width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="">
                                            <input type="text" name="type" id="type" class="input-text lh30" size="40" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="td_right"><font color="red">*</font>最大负重：</td>
                                        <td class="">
                                            <input type="text" name="capacity" id="capacity" class="input-text lh30" size="40" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="td_right"><font color="red">*</font>最大直线行驶速度：</td>
                                        <td class="">
                                            <input type="text" name="maxVel" id="maxVel" class="input-text lh30" size="40" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="td_right"><font color="red">*</font>拐弯速度：</td>
                                        <td class="">
                                            <input type="text" name="turnVel" id="turnVel" class="input-text lh30" size="40" />
                                        </td>
                                    </tr>
